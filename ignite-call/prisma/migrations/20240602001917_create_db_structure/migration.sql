...
-- AddForeignKey
ALTER TABLE `user_tima_intervals` ADD CONSTRAINT `user_tima_intervals_user_id_fkey` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
